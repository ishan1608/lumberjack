var Entities = {
    init: function (data) {
        ...
        var wallLocations = [
            [0, 0, 48, 600], // Left wall
            [0, 528, 768, 72], // Floor
            [192, 384, 336, 216], // Center obstacle
            [726, 0, 42, 600], // Right wall (extension of pipe)
        ];
    ...
    helpers: {
        ...
        Coin: function (img, x, y, w, h) {
            ...
            this.sprite = new Entities.helpers.Sprite(img, 99, 0, 10, 14, x, y, w, h);
            this.spriteAnimations = {
                spin: {
                    frames: [
                        new Entities.helpers.Sprite(img, 99, 0, 10, 14, x, y, w, h),
                        new Entities.helpers.Sprite(img, 115, 0, 10, 14, x, y, w, h),
                        new Entities.helpers.Sprite(img, 131, 0, 10, 14, x, y, w, h),
                        new Entities.helpers.Sprite(img, 147, 0, 10, 14, x, y, w, h)
                    ],
                    currentFrame: 0
                }
            };
